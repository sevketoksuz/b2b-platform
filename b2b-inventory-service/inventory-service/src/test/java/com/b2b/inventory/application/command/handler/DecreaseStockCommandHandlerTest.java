...
class DecreaseStockCommandHandlerTest {
    ...
    void setUp() {
        ...
        handler = new DecreaseStockCommandHandler(
    ...
    @Test
    void shouldDecreaseStockAndCreateMovementWhenStockIsEnough() {
