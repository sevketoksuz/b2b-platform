...
class CompleteOrderCommandHandlerTest {
    ...
    void setUp() {
        ...
        handler = new CompleteOrderCommandHandler(orderRepositoryPort);
    }
    ...
    void shouldCompleteConfirmedOrder() {
        ...
        ChangeOrderStatusResult result = handler.handle(new CompleteOrderCommand(orderId));
    ...
    @Test
    void shouldThrowExceptionWhenOrderIsNotConfirmed() {
        UUID orderId = UUID.randomUUID();
