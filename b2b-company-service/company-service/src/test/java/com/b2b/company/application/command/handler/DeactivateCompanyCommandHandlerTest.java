...
class DeactivateCompanyCommandHandlerTest {

    private CompanyRepositoryPort companyRepositoryPort;
    private DeactivateCompanyCommandHandler handler;

    @BeforeEach
    void setUp() {
        companyRepositoryPort = mock(CompanyRepositoryPort.class);
        handler = new DeactivateCompanyCommandHandler(companyRepositoryPort);
    }

    @Test
    void shouldDeactivateCompanyWhenCompanyExistsAndIsActive() {
        ...
        DeactivateCompanyCommand command = new DeactivateCompanyCommand(companyId);
        ...
        assertEquals(CompanyStatus.INACTIVE, result.status());
